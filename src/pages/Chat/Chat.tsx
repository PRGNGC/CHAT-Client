...
export function Chat() {
	const togglers = useAppSelector(togglersSelector);
		...
		<div className={styles.chatPage}>
			...
			<div className={styles.mainBlock}>
				...
				<div className={styles.mainBlockContent}>
					{togglers.showChat && <ChatBlock />}
					{!togglers.showChat && <SearchBlock />}
					{togglers.userInfoStatus && <UserInfo />}
					{togglers.chatInfoStatus && <ChatInfo />}
				</div>
			</div>
			<Ellipse2 />
			<Ellipse3 />
